...
- [[#package-management][Package Management]]
  - [[#packaged-with-gnu-emacs][Packaged with GNU Emacs]]
    - [[#put-some-of-these-requires-into-hooks][put some of these "require"s into hooks]]
...
#+begin_src emacs-lisp
  ...
  (keymap-global-set "C-c b m" (lambda () (interactive) (switch-to-buffer "*Messages*")))
  (keymap-global-set "C-c b s" (lambda () (interactive) (switch-to-buffer "*scratch*")))
...
Easily switch to it:
#+begin_src emacs-lisp
  (keymap-global-set "C-c s" (lambda () (interactive) (switch-to-buffer "*scratch*")))
#+end_src
...
*** TODO put some of these "require"s into hooks
#+begin_src emacs-lisp
  (require 'dired-x)
  (require 'project)
...
#+begin_src emacs-lisp
  (with-eval-after-load "org"
    (bind-key "M--" #'org-cycle-list-bullet org-mode-map))
#+end_src
...
** Org Indent
Actually don't use this it ruins the perfect head/list ratio in DWM
#+begin_src emacs-lisp
